...
HRESULT GlobalValues::initValues(const HWND &hwnd) {
    ...
    this->archer_center_y = this->height * 0.85;
    this->ground_level = this->archer_center_y + this->arrow_distance_from_archer_center + this->arrow_length;
